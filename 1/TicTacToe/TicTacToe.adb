...
procedure Game is
   ...
   begin
      ...
      Get_Line(input, size);
      Put("");
      return Integer'Value(input(1..size));
   ...
   procedure TicTacToe is
      ...
      subtype T_FieldLengthSquare is Integer range 1 .. FieldLength**2;
   ...
   begin
      ...
      begin
         ...
         StartPlayer := GetActivePlayer(Num);
      end;
      
      for Round in T_FieldLengthSquare'Range loop
         if StartPlayer = Player1 then
            ActivePlayer := GetActivePlayer (Round);
         else
            ActivePlayer := GetActivePlayer (Round + 1);
         end if;
   ...
   procedure myTicTacToe is new TicTacToe(determineFieldSize);
begin
